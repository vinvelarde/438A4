...
//
// NOTES:
// 	- This runs worker processes
//	- Run this on 1 or more servers after starting the master
//		server process.
//
//-------------------------------------------------------------
...
int main(int argc, char** argv) {
	...
	/*
	// CREATE CHILD TO SEND HEARTBEAT
	// 	- Child must kill itself if parent dies
	*/
